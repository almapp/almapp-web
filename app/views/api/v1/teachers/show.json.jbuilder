json.set! json_root do
  ...
  json.academic_unities do
    json.cache_collection_if! should_cache?, @item.academic_unities, key: 'compact' do |unity|
  ...
  json.periods get_periods do |periods|
    json.set! periods.year do
      json.array! periods.periods do |period|
        json.set! period do
          json.courses do
            json.cache_collection_if! should_cache?, @item.courses_for_period(periods.year, period), key: 'compact', expires_in: long do |course|
          ...
          json.sections do
            json.cache_collection_if! should_cache?, @item.sections.period(periods.year, period), key: 'compact' do |section|
