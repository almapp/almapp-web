...
ActiveRecord::Schema.define(version: 20141221013535) do
  ...
  create_table "enrolled_careers", force: :cascade do |t|
    t.integer  "user_id",        null: false
  ...
  create_table "events_assistances", force: :cascade do |t|
  ...
  create_table "faculties_groups", force: :cascade do |t|
  ...
  create_table "groups_organizations", force: :cascade do |t|
    t.integer "group_id",        null: false
    t.integer "organization_id", null: false
  end
  ...
  create_table "groups_subscribers", force: :cascade do |t|
    t.integer  "user_id",                      null: false
    t.integer  "group_id",                     null: false
